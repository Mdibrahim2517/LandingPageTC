        ...
        <>
                ...
                <div className="text-x1 container mx-auto flex justify-between items-center">
                    <div className="flex space-x-14 items-center">
                        <a href="/" className='text-2x1 font-semibold flex items-center space-x-3 text-black text-xl cursor-default'>
                            ...
                            <span className="cursor-default text-pt2 font-semibold text-3xl">Guidance</span></a>
                    ...
                    hover:text-white hover:bg-primary text-xl shadow transition transform hover:-translate-x-1 motion-reduce:transition-none motion-reduce:hover:transform-none active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all'><a href="/SideBar">Get Started</a></button>
                    </div>
            ...
            <div className={` bg-contain z-50 space-y-4 px-4 pt-24 pb-5 bg-white text-primary text-xl md:hidden ${MenuOpen ? "block fixed top-0 right-0 left-0" : "hidden"}`} id="z-auto">
                ...
                <div className="">
                    ...
                    <button className='bg-pt py-2 px-4 transtion-all duration-300 rounded-full
                    hover:text-white hover:bg-primary text-lg shadow transition transform hover:-translate-x-1 motion-reduce:transition-none motion-reduce:hover:transform-none active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all ml-40'><a href="/SideBar">Get Started</a></button>
                </div>
